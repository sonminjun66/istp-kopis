    ...
    e.fn.carouselTicker = function(n) {
        ...
        function r() {
            u.on("mouseover", function() {
                ...
                e && (clearInterval(l.intervalPointer),
                l.intervalPointer = !1)
            })
        }
        function c() {
            u.on("mouseleave", function() {
                var e = "horizontal" === l.settings.mode ? l.itemsWidth > l.$parent.width() : l.itemsHeight > l.$parent.height();
                if (l.isMousemove && (l.$list.off(l.eventTypes.mousemove),
                l.$list.trigger(l.eventTypes.mouseup)),
                e) {
                    if (l.intervalPointer)
                        return;
        ...
        function a() {
            ...
            l.$list.on(l.eventTypes.mousedown, function(i) {
                ...
                o.on(l.eventTypes.mousemove, function(i) {
                    ...
                    l.isMousemove = !0,
                    t && ("horizontal" === l.settings.mode ? (r - u >= 0 && 1 === l.directionSwitcher && (o.css("left", "-=" + l.itemsWidth),
                    r = -l.itemsWidth,
                    n = i.clientX || event.touches[0].pageX,
                    u = 0),
                    r - u <= -l.itemsWidth && -1 === l.directionSwitcher && (o.css("left", 0),
                    r = 0,
                    u = 0,
                    n = i.clientX || event.touches[0].pageX),
                    o.css("left", r - u + "px")) : "vertical" === l.settings.mode && (c - d >= 0 && 1 === l.directionSwitcher && (o.css("top", "-=" + l.itemsHeight),
                    c = -l.itemsHeight,
                    s = i.clientY || event.touches[0].pageY,
                    d = 0),
                    c - d <= -l.itemsHeight && -1 === l.directionSwitcher && (o.css("top", 0),
                    c = 0,
                    d = 0,
                    s = i.clientY || event.touches[0].pageY),
                    o.css("top", c - d + "px")))
            ...
            l.$list.on(l.eventTypes.mouseup, function(i) {
                var n = e(i.target);
                i.preventDefault(),
                (n.attr("href") || n.parents().attr("href") && l.isMousemove) && n.on("click", function(e) {
                    e.preventDefault()
                }),
                t = !1,
                l.isMousemove = !1,
                ...
                l.touch && (l.intervalPointer = setInterval(function() {
                    m()
                }, l.settings.delay))
            })
        }
        ...
        var d = function() {
          ...
          , v = function() {
            ...
            "horizontal" === l.settings.mode ? (s(),
            l.itemsWidth > l.$parent.width() && (u.find("." + l.wrapCls).css({
            ...
            t())) : "vertical" === l.settings.mode && (o(),
            l.itemsHeight > l.$parent.height() && (u.find("." + l.wrapCls).css({
            ...
            t())),
            l.isInitialize && u.on("dragstart", function(e) {
        ...
        return h.resizeTicker = function() {
            s(),
            l.itemsWidth > l.$parent.width() ? l.isInitialize || d() : l.isInitialize && h.destructor()
        }
        ,
        h.stop = function() {
            clearInterval(l.intervalPointer),
        ...
        h.destructor = function() {
            ...
            u.find("." + l.wrapCls).length && (l.$list.unwrap(),
            l.$list.css({
                left: "auto",
                position: "static",
                width: "auto"
